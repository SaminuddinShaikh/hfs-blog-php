		...
		<div class="about-us-main">
			<div class="about_us_main_left head_txt">
				<div class="txt" id="Abot-hfsl">
					<h1><?=$heading?></h1>
					<!--<p>HFS is an emerging Indian NBFC (Non-Banking Financial Company) that caters to the need of aspirational Indian entrepreneurs and provides tailor-made financial products to fulfil the dreams and aspirations of every individual. Our focus on technology and data science enables us to customize our product offerings to entrepreneurs in an efficient and transparent manner.</p>-->
					<!--<p>We as a company firmly believe in<br/>-->
					<!--<span class="bold">Trust</span> in what we do<br>-->
					<!--<span class="bold">Transparency</span> in our dealings<br>-->
					<!--<span class="bold">Technology</span> at the forefront</p>-->
					<?=$desc?>
				</div>
				<div class="about_us_info">
					<div class="abt-sec1 wow fadeIn" id="Abot-Vision">
						<div class="left">
							<!--<ul>-->
							<!--	<li><i class="abt_icon1"><img src="images/icon/vision.png" draggable="false" alt="vision" /></i></li>-->
							<!--	<li><h5>Brand Vision</h5></li>-->
							<!--</ul>-->
							<ul>
							    <li><i class="abt_icon1"><img src="<?=$icon1?>"></i></li>
							    <li><h5><?=$name1?></h5></li>
							</ul>
							
						</div>
						<!--<div class="right"><p>We want to fuel the spirit of entrepreneurship in every individual and contribute to the economic growth of India. With focus on innovation and technology we aim to be the preferred choice of entrepreneurs in India.</p></div>-->
					    <div class="right"><p><?=$desc1?></p></div>
					</div>
				
					<div class="abt-sec2 wow fadeIn" id="Abot-mission">
						<div class="left">
							<ul>
								<!--<li><i class="abt_icon2"><img src="images/icon/mission.png" draggable="false" alt="On a mission" /></i></li>-->
								<!--<li><h5>On a Mission</h5></li>-->
								<li><i class="abt_icon1"><img src="<?=$icon2?>"></i></li>
							    <li><h5><?=$name2?></h5></li>
							</ul>
						</div>
						<div class="right">
						    <p><?=$desc2?></p>
							<!--<p>To maintain highest level of governance, sound business practices, firm commitment to credit standards. We intend to be  a customer-centric organisation and offer unique value proposition to every customer as per their requirements</p>-->
						</div>
					</div>
					...
					<div class="abt-sec3 wow fadeIn" id="Abot-hoh">
						<div class="left">
							<ul>
								<!--<li><i class="abt_icon4"><img src="images/icon/manegment.png" draggable="false" alt="manegment" /></i></li>-->
								<!--<li><h5>A dedicated team  on a mission to empower MSME<span class="small_txt">s</span></h5></li>-->
								<li><i class="abt_icon1"><img src="<?=$icon3?>"></i></li>
							    <li><h5><?=$name3?></h5></li>
							</ul>
						</div>
						<div class="right">
			...
			<div class="about_us_main_right">
				...
				<div class="vdeo_img">
					<a href="https://www.youtube.com/embed/W-Z_qBe5uI4" class="walkthrough"><p><img src="images/icon/video-icon.png" alt="" draggable="false"/></p></a>
				</div>	
			</div>
		</div>
	</div>
