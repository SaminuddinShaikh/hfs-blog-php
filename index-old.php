...
fbq('init', '134649735141267'); 
fbq('track', 'PageView');
</script>
<noscript>
<img height="1" width="1" 
src="https://www.facebook.com/tr?id=134649735141267&ev=PageView
&noscript=1"/>
</noscript>
                        ...
                        echo '<li>
                    			...
                    			<div class="caption">
                    				<div class="slide-txt firstslide">
                    					...
                    					<h4>' .$row['cap_4'].'</h4>
                    					<a href="book-our-visit.php" class="book_our_visit">Let’s meet</a><br>
						...
						<li>
							...
							<div class="calc_btsec">
								<div class="center-side">
									<a href="book-our-visit.php" class="btn book_our_visit">Let's Meet </a>
								</div>
							</div>
						</li>
					</ul>
...
<div class="ticker">
<div class="ticker__item"> <a href="https://hfs-website-prd.azurewebsites.net/pdf/Grievance_Redressal_Mechanism.pdf"rel="noopener noreferrer" target="_blank" style="text-decoration:none; color:#fff;">Grievance Redressal Mechanism (For handling of grievance relating to credit of ex-gratia payment to Customers) Click here. </a>  </div>
</div>
</div> 
</body>
</html>