...
<section id="about-us">
    ...
    <tr class="values_odd">
        ...
        <td class="text_column_odd"> <p class="arrow">Our intent is to keep people at the centre of everything. Win them over by delightful and unique customer experiences, through every interaction across various touch points.</P>
        </td>
    ...
    <tr class="values_even">
        ...
        <td class="text_column_even"> <p class="arrow">Fostering collaborative effort helps every team member conceive unique and innovative solutions. Working together ensures a win for both; the customer and for us, every single time.</P>
        </td>
    ...
    <tr class="values_odd">
        ...
        <td class="text_column_odd">   <p class="arrow ">Trust is the cornerstone in any relationship. We endeavour to build this through every interaction we have with our stakeholders, every single time, building and sustaining our brand’s credibility.</P>
        </td>
    ...
    <tr class="values_even">
        <td class="text_column_even"><p class="arrow ">Each day presents us with opportunities to learn, evolve and improvise ourselves as an organisation. This enables us to uniquely engage and offer solutions to every new customer at their point of need.</p>  
        </td>
    ...
    <div class ="customer_experience">
        ...
        <img src="betatesting/Website/Value 11.jpg" />
         ...
         <p class="arrow">Our intent is to keep people at the centre of everything. Win them over by delightful and unique customer experiences, through every interaction across various touch points.</P>
        ...
        <div class="customer_experience">
            ...
            <p class="arrow ">Fostering collaborative effort helps every team member conceive unique and innovative solutions. Working together ensures a win for both; the customer and for us, every single time.</P>
        ...
        <div class="customer_experience">
         ...
         <div class ="bct_text_area">
             <p class="arrow ">Trust is the cornerstone in any relationship. We endeavour to build this through every interaction we have with our stakeholders, every single time, building and sustaining our brand’s credibility.</P>
        </div>
        ...
        <div class="customer_experience">
            ...
            <div class ="ie_text_area">
             <p class="arrow ">Each day presents us with opportunities to learn, evolve and improvise ourselves as an organisation. This enables us to uniquely engage and offer solutions to every new customer at their point of need.</p>
        </div>
