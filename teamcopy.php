...
<section class="text-center"id="about-us">							
				...
				<div class="tab-sub">
					<ul id="tab-button">
						<li class="ft50"><a href="#eligibility">BOD<!--<span>How much loan could you borrow</span>--></a></li>
						<li class="ft50 mar_lr"><a href="#emi-calculator">Senior management <!--<span>Know your monthly repayment</span>--></a></li>
					</ul>
				</div>
